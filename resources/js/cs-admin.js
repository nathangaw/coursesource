;(function ($) {
    ...
    var createProductEditButton = function (importBtn, productId) {
        var productEditUrl = CoursesourceListTable.adminurl + "post.php?post=" + productId + "&amp;action=edit";
    ...
    $(document).ready(function () {
        ...
        $('.coursetitle').click(function (e) {
            ...
            $('body').addClass('cs-course-details');
            tb_show(
         ...
         *
         */
        $('body.product_page_course-source-import').on('thickbox:removed', function (e) {
            stopCourseImporting = true;
            let target = e.target;
            if (target.classList.contains('cs-course-details')) {
                target.classList.remove('cs-course-details');
            } else {
         ...
         *
         */
        $('body.product_page_course-source-import').on('coursesource-thickbox-close', function (e) {
